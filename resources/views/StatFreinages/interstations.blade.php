{{-- resources/views/StatFreinages/interstations.blade.php --}}
@extends('StatFreinages.layout')

@section('title', 'StatFreinages - Répartition par Inter-station')

@section('StatFreinages-content')
<div x-data="repartitionInterstations()" x-init="init()">
    <!-- Overlay de chargement -->
    <div x-show="Alpine.store('StatFreinages').loading" class="loading-overlay">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-muted small" x-text="`Données du ${formatDate(Alpine.store('StatFreinages').filtres.debut)} au ${formatDate(Alpine.store('StatFreinages').filtres.fin)}`"></div>
    </div>
